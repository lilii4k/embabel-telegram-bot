...
interface SurveyRepository : JpaRepository<Survey, Long> {
    fun findByChatIdAndStatus(chatId: Long, status: SurveyStatus): List<Survey>
    fun findTopByChatIdAndStatusOrderByCreatedAtDesc(chatId: Long, status: SurveyStatus): Survey?
}
